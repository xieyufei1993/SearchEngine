...
query_path = r'D:\Python code\SearchEngine_data\Query'
raw_data_path = r'D:\Python code\SearchEngine_data\Rawdata\trec_data1_renameCheckSum'
processed_data_path = r'D:\Python code\SearchEngine_data\processed'
