...
def readStandard(filename=r'D:\Python code\Search_Engine\EvaluationData\11qrels_visit_checksum.txt'):
	'''
	'''
...
def readMyResult(filename=r'D:\Python code\Search_Engine\EvaluationData\result.txt'):
	'''
	'''
	with open(filename) as f:
		for line in f:
